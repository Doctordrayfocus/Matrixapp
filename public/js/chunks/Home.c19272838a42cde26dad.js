  ...
  methods: {
    multiplyMatrices: function multiplyMatrices() {
      ...
      axios.post('/multiply_matrices', {
        ...
        _this.errorInfo = error.response.data.status;
        _this.$root.routeIsLoading = false;
      });
    }
  }
            ...
            [
              ...
              _c(
                ...
                [
                  _c(
                    "div",
                    {
                      staticClass: "col-md-4 px-0 py-md-0 py-2 ",
                      staticStyle: {
                        "align-items": "center",
              ...
              !_vm.loading && _vm.result.number
                ? [
                    ...
                    _c(
                      "div",
                      { staticClass: "d-flex flex-row col-12 flex-wrap mt-3 " },
                      [
                        _c(
                          "div",
                          {
                            staticClass: "col-md-6  d-flex flex-row flex-wrap",
                            staticStyle: { "align-items": "center" }
                          },
                          [
                            _vm._m(5),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-12 text-center text-danger" }, [
